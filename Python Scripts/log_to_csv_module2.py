...
def main(path: str):
    ...
    if len(LOG_FILE_PATH) < 1:
        ...
        pass
    temp_data, errors_parsed_list,ohms, total_time_mins, log_start_time, log_end_time, new_all_counts = parse_log(lines)
...
def write_csv_data(temp, output_log_csv_name,
    ...
    # stn_5 = Infeed
    # stn_6b_1 = Wick Pick 1
    # stn_6b_2 = Wick Pick 2
    # stn_6c = Wick Flip
    # stn_6d = Wick Pick Vision
    # stn_6 = Wick Compress/Place
    # stn_7_1 = FG Vision 1
    # stn_7_2 = FG Vision 2
    # stn_8 = Wick Flip
    # stn_9 = Wick Flip Vision
    # stn_10 = Outfeed
...
# temp_data, errors_parsed_list,ohms, total_time_mins, log_start_time, log_end_time, M1_new_all_counts = parse_log(lines)
# write_csv_data(temp_data, log_csv_name, errors_parsed_list,
#                ohms, total_time_mins, log_start_time, log_end_time, M1_new_all_counts)
