...
#                              ])
    ...
    new_counts = OrderedDict([("Start", 0), ("End", 0), ("Output", fg_vision1_ok + fg_vision1_fail), #incoming parts for vision inspection
                              ...
                              ("Fail", fg_vision1_fail + fg_vision2_fail+invert_vision_fail+(fg_vision2_ok-invert_vision_fail-invert_vision_ok)), #total failure in fg_vision1 and fg_vision2 and invert_vision and outfeed errors
                              ("DT", 0), ("Run Time", 0), ("Assist", 0),
